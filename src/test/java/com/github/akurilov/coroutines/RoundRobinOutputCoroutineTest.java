...
public class RoundRobinOutputCoroutineTest {
	...
	private static final CoroutinesProcessor COROUTINE_PROCESSOR = new CoroutinesProcessor();
	...
	private final RoundRobinOutputCoroutine rrcOutput;
	...
	public RoundRobinOutputCoroutineTest(final int outputCount)
		...
		rrcOutput = new RoundRobinOutputCoroutine(COROUTINE_PROCESSOR, outputs, BATCH_SIZE);
		rrcOutput.start();
