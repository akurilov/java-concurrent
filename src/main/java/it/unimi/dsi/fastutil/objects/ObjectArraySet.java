...
public class ObjectArraySet<K> extends AbstractObjectSet<K>
	...
	@SuppressWarnings("unchecked")
	public it.unimi.dsi.fastutil.objects.ObjectArraySet<K> clone() {
		it.unimi.dsi.fastutil.objects.ObjectArraySet<K> c;
		try {
			c = (it.unimi.dsi.fastutil.objects.ObjectArraySet<K>) super.clone();
