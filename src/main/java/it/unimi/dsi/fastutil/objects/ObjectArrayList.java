...
public class ObjectArrayList<K> extends AbstractObjectList<K>
	...
	public static <K> it.unimi.dsi.fastutil.objects.ObjectArrayList<K> wrap(final K a[], final int length) {
		if (length > a.length)
			throw new IllegalArgumentException("The specified length ("
					+ length + ") is greater than the array size (" + a.length
					+ ")");
		final it.unimi.dsi.fastutil.objects.ObjectArrayList<K> l = new it.unimi.dsi.fastutil.objects.ObjectArrayList<K>(a, false);
		l.size = length;
		return l;
	}
	...
	public static <K> it.unimi.dsi.fastutil.objects.ObjectArrayList<K> wrap(final K a[]) {
	...
	public ObjectListIterator<K> listIterator(final int index) {
		...
		return new AbstractObjectListIterator<K>() {
			...
			public void add(K k) {
				it.unimi.dsi.fastutil.objects.ObjectArrayList.this.add(pos++, k);
				last = -1;
			}
			public void set(K k) {
				if (last == -1)
					throw new IllegalStateException();
				it.unimi.dsi.fastutil.objects.ObjectArrayList.this.set(last, k);
			}
			public void remove() {
				if (last == -1)
					throw new IllegalStateException();
				it.unimi.dsi.fastutil.objects.ObjectArrayList.this.remove(last);
				/*
	...
	public it.unimi.dsi.fastutil.objects.ObjectArrayList<K> clone() {
		it.unimi.dsi.fastutil.objects.ObjectArrayList<K> c = new it.unimi.dsi.fastutil.objects.ObjectArrayList<K>(size);
	 ...
	 */
	public boolean equals(final it.unimi.dsi.fastutil.objects.ObjectArrayList<K> l) {
		if (l == this)
			return true;
		int s = size();
		if (s != l.size())
	 ...
	 */
	@SuppressWarnings("unchecked")
	public int compareTo(final it.unimi.dsi.fastutil.objects.ObjectArrayList<? extends K> l) {
