...
public class Object2IntOpenHashMap<K> extends AbstractObject2IntMap<K>
	...
	private class MapIterator {
		 ...
		 * key.
		 */
		boolean mustReturnNullKey = it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap.this.containsNullKey;
		/**
		...
		public int nextEntry() {
			...
			final K key[] = it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap.this.key;
		...
		public void remove() {
			...
			if (last == n) {
				...
				it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap.this.remove(wrapped.set(-pos - 1, null));
	...
	private final class MapEntrySet
		...
		public boolean contains(final Object o) {
			...
			if (((k) == null))
				return it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap.this.containsNullKey
						&& ((value[n]) == (v));
		...
		public void clear() {
			it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractObjectSet<K> {
		...
		public boolean remove(Object k) {
			...
			it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap.this.remove(k);
			return size != oldSize;
		}
	...
	@SuppressWarnings("unchecked")
	public it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap<K> clone() {
		it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap<K> c;
		try {
			c = (it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap<K>) super.clone();
