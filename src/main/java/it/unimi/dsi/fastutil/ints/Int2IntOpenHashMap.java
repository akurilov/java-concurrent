...
public class Int2IntOpenHashMap extends AbstractInt2IntMap
	...
	private class MapIterator {
		 ...
		 * key.
		 */
		boolean mustReturnNullKey = it.unimi.dsi.fastutil.ints.Int2IntOpenHashMap.this.containsNullKey;
		/**
		...
		public int nextEntry() {
			...
			final int key[] = it.unimi.dsi.fastutil.ints.Int2IntOpenHashMap.this.key;
		...
		public void remove() {
			...
			if (last == n) {
				...
				it.unimi.dsi.fastutil.ints.Int2IntOpenHashMap.this.remove(wrapped.getInt(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Entry>
		implements
		FastEntrySet {
		...
		public boolean contains(final Object o) {
			...
			if (((k) == (0)))
				return it.unimi.dsi.fastutil.ints.Int2IntOpenHashMap.this.containsNullKey
					&& ((value[n]) == (v));
