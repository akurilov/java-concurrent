...
public class Int2ObjectOpenHashMap<V> extends AbstractInt2ObjectMap<V>
	...
	private class MapIterator {
		 ...
		 * key.
		 */
		boolean mustReturnNullKey = it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap.this.containsNullKey;
		/**
		...
		public int nextEntry() {
			...
			final int key[] = it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap.this.key;
		...
		public void remove() {
			...
			if (last == n) {
				...
				it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap.this.remove(wrapped.getInt(-pos - 1));
	...
	private final class MapEntrySet
		...
		public boolean contains(final Object o) {
			...
			if (((k) == (0)))
				return it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap.this.containsNullKey
	...
	@SuppressWarnings("unchecked")
	public it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap<V> clone() {
		it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap<V> c;
		try {
			c = (it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap<V>) super.clone();
