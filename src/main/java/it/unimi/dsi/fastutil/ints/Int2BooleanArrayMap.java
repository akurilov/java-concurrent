...
public class Int2BooleanArrayMap extends AbstractInt2BooleanMap
	...
	private final class EntrySet
		...
		public boolean contains(Object o) {
			...
			return it.unimi.dsi.fastutil.ints.Int2BooleanArrayMap.this.containsKey(k)
				&& ((it.unimi.dsi.fastutil.ints.Int2BooleanArrayMap.this.get(k)) == (((((Boolean) (e
		...
		public boolean remove(final Object o) {
			...
			final int oldPos = it.unimi.dsi.fastutil.ints.Int2BooleanArrayMap.this.findKey(k);
			if (oldPos == -1
				|| !((v) == (it.unimi.dsi.fastutil.ints.Int2BooleanArrayMap.this.value[oldPos])))
				return false;
			final int tail = size - oldPos - 1;
			System.arraycopy(
				it.unimi.dsi.fastutil.ints.Int2BooleanArrayMap.this.key, oldPos + 1,
				it.unimi.dsi.fastutil.ints.Int2BooleanArrayMap.this.key, oldPos, tail);
			System.arraycopy(
				it.unimi.dsi.fastutil.ints.Int2BooleanArrayMap.this.value, oldPos + 1,
				it.unimi.dsi.fastutil.ints.Int2BooleanArrayMap.this.value, oldPos, tail);
			it.unimi.dsi.fastutil.ints.Int2BooleanArrayMap.this.size--;
