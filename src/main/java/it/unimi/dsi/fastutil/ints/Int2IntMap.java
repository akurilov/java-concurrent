...
public interface Int2IntMap extends Int2IntFunction, Map<Integer, Integer> {
	...
	public interface FastEntrySet extends ObjectSet<it.unimi.dsi.fastutil.ints.Int2IntMap.Entry> {
		/**
	...
	ObjectSet<it.unimi.dsi.fastutil.ints.Int2IntMap.Entry> int2IntEntrySet();
