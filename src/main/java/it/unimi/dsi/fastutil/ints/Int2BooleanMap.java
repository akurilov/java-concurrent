...
public interface Int2BooleanMap
	...
	public interface FastEntrySet extends ObjectSet<it.unimi.dsi.fastutil.ints.Int2BooleanMap.Entry> {
		/**
	...
	ObjectSet<it.unimi.dsi.fastutil.ints.Int2BooleanMap.Entry> int2BooleanEntrySet();
